...
class DataTransformation:
    ...
    def initiate_data_transformation(self)->DataTransformationArtifact:
        logging.info("Entered initiate_data_transformation method of data tranbsformation class")
        try:
            ...
            #Now trying to use KNNImputer on the dataset for the missing values, etc
